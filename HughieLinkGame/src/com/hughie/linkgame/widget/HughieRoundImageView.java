...
public class HughieRoundImageView extends ImageView {
	...
	public HughieRoundImageView(Context context) {
		super(context);
		this.mContext = context;
	}
	
	public HughieRoundImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.mContext = context;
		setCustomAttributes(attrs);
	}

	public HughieRoundImageView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void onDraw(Canvas canvas) {
		try{
			...
			HughieLoggerManager.println("绘制圆形头像出错。");
